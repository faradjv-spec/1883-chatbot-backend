...
// GET /api/availability?checkIn=2026-04-01&checkOut=2026-04-03&adults=2
router.get('/', async (req, res) => {
  try {
    ...
    const response = await exelyClient.get('/api/v1/availability', {
      params: {
    ...
    res.status(502).json({ error: 'Failed to fetch availability', detail: err.message });
  }
});
